module.exports = [
    ...
    },
    {
        ...
        notificationTypeName:"新的交易需求"	,//	enum int	通知类型 1 有人向你发起积分合同 2 有人向你发起了电力合同 3 新的交易需求 4 拒绝信息
    ...
    },
    {
        ...
        notificationTypeName:"收到积分合同请求"	,//	enum int	通知类型 1 有人向你发起积分合同 2 有人向你发起了电力合同 3 新的交易需求 4 拒绝信息
        state:	2,//	enum int	1 已查看 2 未查看
        publishDateTime:'2022/7/18 20:20:20'	,//	datetime	通知发出时间
    },
    {
    ...
    },
    {
        ...
        message:"你的交易请求被拒绝了！"	,//	varchar	通知的信息
        notificationTypeName:"请求被拒绝"	,//	enum int	通知类型 1 有人向你发起积分合同 2 有人向你发起了电力合同 3 新的交易需求 4 拒绝信息
        state:	2,//	enum int	1 已查看 2 未查看
    ...
    {
        notificationId:13,//long int	通知ID 自动 pk
        senderCode: 'AAA113'	,//	varchar	用户表主键 表示是哪个用户发出的消息
        recipientCode:'AAA135'	,//	varchar	用户表主键 表示消息是谁来接收
        message:"有人发出了新的交易需求"	,//	varchar	通知的信息
        notificationTypeName:"新的交易需求"	,//	enum int	通知类型 1 有人向你发起积分合同 2 有人向你发起了电力合同 3 新的交易需求 4 拒绝信息
        state:	2,//	enum int	1 已查看 2 未查看
        publishDateTime:'2022/7/21 07:53:85'	,//	datetime	通知发出时间
    ...
    {
        notificationId:14,//long int	通知ID 自动 pk
        senderCode: 'AAA113'	,//	varchar	用户表主键 表示是哪个用户发出的消息
        recipientCode:'AAA144'	,//	varchar	用户表主键 表示消息是谁来接收
        message:"有人向你发起了积分合同"	,//	varchar	通知的信息
        notificationTypeName:"收到电力合同请求"	,//	enum int	通知类型 1 有人向你发起积分合同 2 有人向你发起了电力合同 3 新的交易需求 4 拒绝信息
        state:	2,//	enum int	1 已查看 2 未查看
        publishDateTime:'2022/7/18 20:20:20'	,//	datetime	通知发出时间
    },
    {
        notificationId:15,//long int	通知ID 自动 pk
        senderCode: 'AAA113'	,//	varchar	用户表主键 表示是哪个用户发出的消息
        recipientCode:'AAA113'	,//	varchar	用户表主键 表示消息是谁来接收
        message:"有人向你发起了积分合同"	,//	varchar	通知的信息
        notificationTypeName:"收到电力合同请求"	,//	enum int	通知类型 1 有人向你发起积分合同 2 有人向你发起了电力合同 3 新的交易需求 4 拒绝信息
