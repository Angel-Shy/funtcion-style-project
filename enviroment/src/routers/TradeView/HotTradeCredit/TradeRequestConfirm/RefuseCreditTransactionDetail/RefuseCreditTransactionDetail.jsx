...
import stl from './RefuseCreditTransactionDetail.module.scss';
...
function RefuseCreditTransactionDetail(props) {
    ...
    return (
        <div>
            ...
            <textarea placeholder={'拒绝理由...'} onChange={TextAreaChangeEvent}  className={stl.textarea}></textarea>
...
export default RefuseCreditTransactionDetail;
